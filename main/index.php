...
<?php
session_start();
$userType = $_SESSION['user_type'] ?? null; // Check if the user is logged in and their type
$username = $_SESSION['username'] ?? null; // Check if the user is logged in
?>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    ...
                                    <p class="fs-5 fw-medium text-white mb-4 pb-2">Vero elitr justo clita lorem. Ipsum
                                        ...
                                        rebum sea elitr.</p>
                                    <?php if ($userType === 'A'): ?>
                                    <a href="/main/recruiter-jobpost.html"
                                        class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Post a Job</a>
                                    <?php else: ?>
